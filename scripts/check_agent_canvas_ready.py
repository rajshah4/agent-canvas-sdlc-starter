...
def check_server(base: str) -> tuple[bool, str]:
    ...
    try:
        ...
        return True, f"Agent Server {data.get('version', 'unknown')} at {base} with required starter and delegation tools"
...
def main() -> int:
    ...
    print("INFO create the parent Agent Canvas conversation with terminal/file tools; the repo-local factory script creates visible child conversations.")
